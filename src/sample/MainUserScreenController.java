...
public class MainUserScreenController implements Initializable {
    ...
    final static Image image12=new Image(("File:\\Users\\jjoog\\Desktop\\MusicApp\\src\\sample\\Graphics\\cover.png").toString());
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        ImageView tutorialImage=new ImageView("File:\\jjoog\\Desktop\\MusicApp\\src\\sample\\Graphics\\tutorial.png");
...
///
    ...
    public void CreateSongs(AnchorPane ap,VBox vOne, ScrollPane scrollPane, Album album){
        ...
        for(int i = 0; i< nameMusic.size(); i++) {
                ...
                Media media = new Media(new File("C:\\Users\\jjoog\\Desktop\\MusicApp\\src\\sample\\Music\\"+(nameMusic.get(i)).toString()).toURI().toString()+".mp3");
    ...
    public void mainMenuIcons(Pane pane){
        ...
        ImageView imageView2=new ImageView(("File:\\Users\\jjoog\\Desktop\\MusicApp\\src\\sample\\Graphics\\cart.png"));
        ImageView imageView3=new ImageView(("File:\\Users\\jjoog\\Desktop\\MusicApp\\src\\sample\\Graphics\\ic_favorite_border_white_48pt_3x.png"));
